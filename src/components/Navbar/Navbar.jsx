...
export default function Navbar({displaySideBar}) {
  return (
    <nav
      className={`w-full h-full  flex  bg-[rgba(221,221,221,0.4)] border-white border-b rounded-b-3xl `}
    >
      <ul className={` w-[90%] h-[80%] flex  m-auto  justify-between`}>
        ...
        <li
          className={`w-[6%] h-full  flex hover:cursor-pointer
            ...
            `}
        >
          <HeartIcon className={`w-full text-black `} />{" "}
        </li>
        <li
          className={`w-[6%] h-full  flex hover:cursor-pointer
        ...
        >
          <li className="flex w-full h-full">
            <button
              type="button"
              className="w-[6rem] h-[2.2rem] bg-[rgba(221,221,221,0.4)] outline-white outline outline-1 rounded-3xl m-auto"
            >
              Connexion
            </button>
          </li>
